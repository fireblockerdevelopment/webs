...
export default function Hero() {
    ...
    useEffect(() => {
        setIsMounted(true);
        // Check if video was already watched in this session to avoid annoyance
        // But the user specifically asked for "on page load or refresh", so I'll follow that.
    }, []);
                ...
                {!isVideoEnded ? (
                    ...
                    >
                        ...
                        <button
                            ...
                            className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 z-[110] flex items-center gap-2 bg-black/40 hover:bg-black/60 backdrop-blur-sm text-white px-5 py-2.5 sm:px-6 sm:py-3 rounded-full border border-white/30 transition-all group text-sm sm:text-base lg:opacity-50 hover:lg:opacity-100"
                        >
                            <span>Geç</span>
